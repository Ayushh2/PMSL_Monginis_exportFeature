...
const allProducts = [
  ...
  // fixed typo: mufffins.png -> muffins.png
...
export function ProductShowcase() {
  ...
  <div style={{ height: '1px', width: '3rem', background: 'linear-gradient(to right, transparent, #f9a8d4)' }} />
  <p
  className="font-semibold text-[#E91E8C] uppercase whitespace-nowrap"
  style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 'clamp(0.6rem, 2.5vw, 0.75rem)', letterSpacing: '0.12em' }}
>
    {t('products.signatureCollections')}
  </p>
  <div style={{ height: '1px', width: '3rem', background: 'linear-gradient(to left, transparent, #f9a8d4)' }} />
</div>
