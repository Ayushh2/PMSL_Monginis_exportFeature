          ...
          {highlights.map((item, i) => (
            ...
            >
              ...
              <h3 style={{
                ...
                fontWeight: 700, fontSize: '1.05rem', color: '#9d174d',
                lineHeight: 1.35,
              }}>
                {item.title}
              </h3>
          ...
          <div className="mfg-grid">
            {manufacturingImages.map((img, i) => (
              <div
                ...
                style={{
                  borderRadius:
                    i === 0 ? '1.25rem 0.75rem 0.75rem 0.75rem'
                    : i === 1 ? '0.75rem 1.25rem 0.75rem 0.75rem'
                    : i === 2 ? '0.75rem 0.75rem 0.75rem 1.25rem'
              ...
              >
                ...
                <div style={{
                  ...
                  background: 'linear-gradient(to top, rgba(157,23,77,0.55) 0%, rgba(157,23,77,0.05) 45%, transparent 70%)',
                  pointerEvents: 'none',
                }} />
